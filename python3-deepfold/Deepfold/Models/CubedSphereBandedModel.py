...
class CubedSphereBandedModel(CubedSphereBaseModel):
    """Cubed Shpere model with banded r layers and witout zero padding in r"""
    ...
    def _init_model(self,
        ...
        ### LAYER 1 ###
        self.layers.append({})
        self.layers[-1].update(self.create_cubed_sphere_conv_banded_layer(len(self.layers)-1,
                                                                          self.layers[-2]['input'],
                                                                          ksize_r=3,
                                                                          ksize_xi=5,
                                                                          ksize_eta=5,
