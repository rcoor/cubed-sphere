if __name__ == '__main__':
    ...
    for output_type in all_output_types:
        for model in ["CubedSphereModel", "SphericalModel"]:
            ...
            cmd = generate_train_cmd(args.mode, model, output_type, data_name, defaults['regularization'],
                                     ...
                                     restore_checkpoint=args.restore_checkpoint, data_dir_postfix="_zsidechain")

            cmds.append(cmd)

    run_cmds(cmds=cmds, devices=['0', '1', '2', '3'], dry=args.dry, force=args.force)
