...
CoordinateSystem = enum.Enum("CoordinateSystem", {"spherical":1, "cubed_sphere":2})
...
_offsets = np.array([[1, 1], [2, 1], [3, 1], [0, 1], [1, 2], [1, 0]])


def cubed_sphere_to_unfolded_plane(patch, xi, eta, offsets=_offsets):
